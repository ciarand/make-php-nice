...
/**
 * A collection of (arguably) useful helpers
 */
...
/**
 * All taken shamelessly from @nikic's fantastic iter library. The only reason
 * they're in here as opposed to just pulling in the main library is that it
 * has a 5.5 dependency and I don't get to use 5.5 at work yet. Also namespaces.
 *
